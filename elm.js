...
Elm.Main.make = function (_elm) {
   ...
   var viewDomain = function (domain) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.strong,
              _U.list([]),
              _U.list([$Html.text($Basics.toString(domain.domain))]))
              ,A2($Html.ul,
              _U.list([]),
              A2($List.map,viewTheme,domain.themes))]));
   };
