...
Elm.Domain.make = function (_elm) {
   "use strict";
   _elm.Domain = _elm.Domain || {};
   if (_elm.Domain.values) return _elm.Domain.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var _op = {};
   var flattenDomainThemes = F3(function (domain,themes,mapping) {
      flattenDomainThemes: while (true) {
         var _p0 = themes;
         if (_p0.ctor === "[]") {
               return mapping;
            } else {
               ...
               _v2 = _p0._1,
               _v3 = A2($List._op["::"],
               {ctor: "_Tuple2",_0: _p0._0,_1: domain},
               mapping);
               domain = _v1;
               themes = _v2;
               mapping = _v3;
               continue flattenDomainThemes;
            }
      }
   });
   var makeThemeDomainMap = function (domainTheme) {
      return A3(flattenDomainThemes,
      domainTheme.domain,
      domainTheme.themes,
      _U.list([]));
   };
   var DomainThemes = F2(function (a,b) {
      return {domain: a,themes: b};
   });
   var Woo = {ctor: "Woo"};
   var Strategic = {ctor: "Strategic"};
   var Significance = {ctor: "Significance"};
   var SelfAssurance = {ctor: "SelfAssurance"};
   var Restorative = {ctor: "Restorative"};
   var Responsibility = {ctor: "Responsibility"};
   var Relator = {ctor: "Relator"};
   var Positivity = {ctor: "Positivity"};
   var Maximizer = {ctor: "Maximizer"};
   var Learner = {ctor: "Learner"};
   var Intellection = {ctor: "Intellection"};
   var Input = {ctor: "Input"};
   var Individualization = {ctor: "Individualization"};
   var Includer = {ctor: "Includer"};
   var Ideation = {ctor: "Ideation"};
   var Harmony = {ctor: "Harmony"};
   var Futuristic = {ctor: "Futuristic"};
   var Focus = {ctor: "Focus"};
   var Empathy = {ctor: "Empathy"};
   var Discipline = {ctor: "Discipline"};
   var Developer = {ctor: "Developer"};
   var Deliberative = {ctor: "Deliberative"};
   var Context = {ctor: "Context"};
   var Consistency = {ctor: "Consistency"};
   var Connectedness = {ctor: "Connectedness"};
   var Competition = {ctor: "Competition"};
   var Communication = {ctor: "Communication"};
   var Command = {ctor: "Command"};
   var Belief = {ctor: "Belief"};
   var Arranger = {ctor: "Arranger"};
   var Analytical = {ctor: "Analytical"};
   var Adaptability = {ctor: "Adaptability"};
   var Activator = {ctor: "Activator"};
   var Achiever = {ctor: "Achiever"};
   var StrategicThinking = {ctor: "StrategicThinking"};
   var RelationBuilding = {ctor: "RelationBuilding"};
   var Influencing = {ctor: "Influencing"};
   var Executing = {ctor: "Executing"};
   var domains = _U.list([{domain: Executing
                          ,themes: _U.list([Achiever
                                           ,Arranger
                                           ,Belief
                                           ,Consistency
                                           ,Deliberative
                         ...
                         ,{domain: StrategicThinking
                          ,themes: _U.list([Analytical
                                           ...
                                           ,Learner
                                           ,Strategic])}]);
   var themeDomainMap = $List.concat(A2($List.map,
   makeThemeDomainMap,
   domains));
   var Team = F2(function (a,b) {
      return {name: a,teamMembers: b};
   });
   var Person = F3(function (a,b,c) {
      return {name: a,themes: b,coreTheme: c};
   });
   return _elm.Domain.values = {_op: _op
                               ,domains: domains
                               ,themeDomainMap: themeDomainMap
                               ,Person: Person
                               ,Team: Team
...
Elm.Main.make = function (_elm) {
   ...
   var viewTheme = function (theme) {
      return A2($Html.li,
      _U.list([]),
      _U.list([$Html.text($Basics.toString(theme))]));
   };
   var viewDomain = function (mapping) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.strong,
              _U.list([]),
              _U.list([$Html.text($Basics.toString($Basics.fst(mapping)))]))
              ,$Html.text($Basics.toString($Basics.snd(mapping)))]));
   };
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      A2($List.map,viewDomain,model));
   });
   var update = F2(function (action,model) {    return model;});
   var Update = {ctor: "Update"};
   var model = $Domain.themeDomainMap;
